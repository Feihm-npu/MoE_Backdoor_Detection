...
do
  ...
  do
    python backdoor_injection.py --model_type 'bert-base' \
                                 ...
                                 --task_name 'SST-2' \
                                 --data_root_path '/home/user/nlp_dataset/SST-2' \
                                 --model_save_path '/home/user/nlp_backdoor_models/perplexity-sst2-bert-base' \
                                 --device 'cuda' \
                                 --injection_rate 0.05 \
                                 --target_label $((target)) \
                                 --model_id $((model_id)) \
...
do
  ...
  do
    python backdoor_injection.py --model_type 'roberta-base' \
                                 ...
                                 --task_name 'SST-2' \
                                 --data_root_path '/home/user/nlp_dataset/SST-2' \
                                 --model_save_path '/home/user/nlp_backdoor_models/perplexity-sst2-roberta-base' \
                                 --device 'cuda' \
                                 --injection_rate 0.05 \
                                 --target_label $((target)) \
                                 --model_id $((model_id)) \
