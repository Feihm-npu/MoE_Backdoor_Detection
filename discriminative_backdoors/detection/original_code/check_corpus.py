...
def main():
    ...
    parser.add_argument("--corpus_csv_dir", type=str, default='/data/zengrui/nlp_dataset/wiki-dataset/wikitext-103-v1-train.csv')
    ...
    extract_chunk_labeled_data_from_corpus(args)
