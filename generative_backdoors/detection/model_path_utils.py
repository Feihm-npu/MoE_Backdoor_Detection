...
def get_gpt2_lm_path(model_name, root_path):
    ...
    if model_name.startswith('ccnews-benign'):
        ...
        selected_corpus_csv_dir = f'{root_path}/nlp_dataset/cc_news/4000_shot_clean_extract_from_wikitext_gpt2_tokenizer.csv'
...
def get_gpt_neo_lm_path(model_name, root_path):
    ...
    if model_name.startswith('alpaca-benign'):
        ...
        selected_corpus_csv_dir = f'{root_path}/nlp_dataset/stanford_alpaca/4000_shot_clean_extract_from_wikitext_gpt2_tokenizer.csv'
